...
class Metaclass_GetTransform_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('navbot_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GetTransform_Event(type):
    """Metaclass of message 'GetTransform_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_transform__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_transform__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_transform__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_transform__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_transform__event
...
class GetTransform_Event(metaclass=Metaclass_GetTransform_Event):
    """Message class 'GetTransform_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<navbot_msgs/GetTransform_Request, 1>',
        'response': 'sequence<navbot_msgs/GetTransform_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['navbot_msgs', 'srv'], 'GetTransform_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['navbot_msgs', 'srv'], 'GetTransform_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from navbot_msgs.srv import GetTransform_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetTransform_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetTransform_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from navbot_msgs.srv import GetTransform_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetTransform_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetTransform_Response'"
...
class Metaclass_GetTransform(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from navbot_msgs.srv import _get_transform
            ...
            if _get_transform.Metaclass_GetTransform_Event._TYPE_SUPPORT is None:
                _get_transform.Metaclass_GetTransform_Event.__import_type_support__()


class GetTransform(metaclass=Metaclass_GetTransform):
    from navbot_msgs.srv._get_transform import GetTransform_Request as Request
    from navbot_msgs.srv._get_transform import GetTransform_Response as Response
    from navbot_msgs.srv._get_transform import GetTransform_Event as Event
