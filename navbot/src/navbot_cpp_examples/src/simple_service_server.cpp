...
public:
    ...
    {
        service_ = create_service<navbot_msgs::srv::AddTwoInts>("add_two_ints",
        std::bind(&SimpleServiceServer::serviceCallback, this, _1, _2));

        RCLCPP_INFO_STREAM(get_logger(), "Service add_two_ints ready");
    }
private:
    rclcpp::Service<navbot_msgs::srv::AddTwoInts>::SharedPtr service_;

    void serviceCallback(std::shared_ptr<navbot_msgs::srv::AddTwoInts::Request> req,
                         std::shared_ptr<navbot_msgs::srv::AddTwoInts::Response> res)
    {
