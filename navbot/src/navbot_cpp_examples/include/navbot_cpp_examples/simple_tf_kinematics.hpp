...
private:
    ...
    rclcpp::Service<navbot_msgs::srv::GetTransform>::SharedPtr get_transform_srv_;
    ...
    bool getTransformCallback(const std::shared_ptr<navbot_msgs::srv::GetTransform::Request> req,
