...
class TwistRelay(Node):
    def __init__(self):
        ...
        self.controller_sub = self.create_subscription(Twist, "/navbot_controller/cmd_vel_unstamped",
            self.controller_twist_callback,
            10)
        self.controller_pub = self.create_publisher(TwistStamped,
                "/navbot_controller/cmd_vel",
                10)
