...
from navbot_msgs.srv import GetTransform
...
class SimpleTfKinematics(Node):
    def __init__(self):
        ...
        self.dynamic_tf_stamped_ = TransformBroadcaster(self)
        ...
        self.static_transform_stamped_.header.frame_id = "navbot_base"
        self.static_transform_stamped_.child_frame_id = "navbot_top"
    ...
    def timerCallback(self):
        ...
        self.dynamic_transform_stamped_.child_frame_id = "navbot_base"
        ...
        self.dynamic_tf_stamped_.sendTransform(self.dynamic_transform_stamped_)

        self.last_x_ = self.dynamic_transform_stamped_.transform.translation.x
    
    def getTransformCallback(self, req, res):
        self.get_logger().info("Requested Transform btween %s and %s" % (req.frame_id, req.child_frame_id))
        ...
        try:
            ...
            self.get_logger().error("An error occured while transforming %s and %s " % (req.frame_id, req.child_frame_id) )
            res.success =False
            return res
