...
class OdometryMotionModel(Node):
    ...
    def __init__(self):
        ...
        self.odom_sub_ = self.create_subscription(Odometry, "navbot_controller/odom_noisy", self.odomCallback, 10)
        self.pose_array_pub_ = self.create_publisher(PoseArray, "navbot_controller/odom_kalman", 10)

      

    def odomCallback(self, odom):
        q = [odom.pose.orientation.x, odom.pose.orientation.y, odom.pose.orientation.z,
